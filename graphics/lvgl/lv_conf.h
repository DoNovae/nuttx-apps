...
#define LV_USE_USER_DATA 1
#define LV_PORT_USE_LCDDEV 1
#define LV_PORT_LCDDEV_DEFAULT_DEVICEPATH "/dev/lcd0"
#define LV_PORT_LCDDEV_LINE_BUFFER_DEFAULT 10
#define LV_PORT_LCDDEV_DOUBLE_BUFFER 1
#define LV_PORT_MEM_CUSTOM_SIZE 0
#define LV_PORT_MEM_ATTRIBUTE_FAST_MEM_SECTION_NAME ""
